...
- [[/cleopatra/][A Series on Generating this Static Website]] ::
  ...
  2. [[/cleopatra/Contents/Org.org][Generating Contents from Org Documents ~(TODO)~]]
  3. [[/cleopatra/Contents/Coq.org][Generating Contents from Coq Documents ~(TODO)~]]
  4. [[/cleopatra/Soupault.html][Configuring ~soupault~ ~(WIP)~]]
